    ...
    return (
        <ProtectedRoute>
            ...
            <div className="p-6 max-w-6xl mx-auto">
                <h1 className="text-3xl font-bold mb-6 text-gray-800">Available Restaurants</h1>

                {loading && <p className="text-orange-500 animate-pulse">Loading restaurants...</p>}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {data?.restaurants?.map((restaurant: any) => (
                        ...
                        >
                            ...
                            <p className="text-gray-500 mt-2 font-medium">🌍 Region: {restaurant.country}</p>
                        </div>
                    ))}
                </div>
            </div>
